...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            // box
            WebElement searchBox =  driver.findElementByClassName("css-b52kj1");
            searchBox.clear();
            searchBox.sendKeys(product);

            Thread.sleep(2000);
            // WebDriverWait wait = new WebDriverWait(driver,30);
            // wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='root']/div/div/div[3]/div[1]/div[2]/div")));
    ...
    public Boolean isNoResultFound() {
        ...
        try {
            ...
            WebElement noResult = driver.findElement(By.tagName("h4"));
    ...
    public Boolean addProductToCart(String productName) {
        ...
        try {
             ...
             */
             ...
             List<WebElement> products = driver.findElements(By.className("css-s18byi"));

             for(WebElement product:products){
                if(product.findElement(By.className("css-yg30e6")).getText().contains(productName)){
                    System.out.println("This is the Matching Product : "+productName);
                    product.findElement(By.className("css-54wre3")).click();
                    Thread.sleep(10000);
                    status = true;
                    return status;
                }
    ...
    public Boolean changeProductQuantityinCart(String productName, int quantity) {        
        try {
            ...
            // WebElement cart = driver.findElement(By.className("css-1q5pok1"));
            // List<WebElement> itoms = cart.findElements(By.className("css-zgtx0t"));

            // System.out.println(itoms.size());


            // for(WebElement itom:itoms){      
            //     System.out.println(itom);          
            //     WebElement element = itom.findElement(By.xpath("//*[@class='MuiBox-root css-1gjj37g']/div[1]"));  
             ...
             * if(initialQuantity>quantity){
                        while(initialQuantity>quantity){
                            itom.findElement(By.xpath("//*[@id='root']/div/div/div[3]/div[2]/div/div/div/div[2]/div[2]/div[1]/button[1]")).click();
                            initialQuantity = Integer.valueOf(itom.findElement(By.className("css-olyig7")).getText());
                        }
                    status = true;
                    }else{
                        while(initialQuantity<quantity){
                            itom.findElement(By.xpath("//*[@id='root']/div/div/div[3]/div[2]/div/div/div/div[2]/div[2]/div[1]/button[2]")).click();
                            initialQuantity = Integer.valueOf(itom.findElement(By.className("css-olyig7")).getText());
                        }
                    status = true;
                    }
            ...
            /*
             * if(itom.findElement(By.xpath("//*[@id='root']/div/div/div[3]/div[2]/div/div/div/div[2]/div[1]")).getText().contains(productName)){
                    System.out.println(productName);
                    WebElement currentQuantity = itom.findElement(By.className("css-olyig7"));
                    int initialQuantity = Integer.parseInt(currentQuantity.getText());
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            // List<WebElement> cartContant = cart.findElements(By.className("css-zgtx0t"));

            // for(WebElement element: cartContant){
            //     WebElement ele = element.findElement(By.xpath("//*[@class='MuiBox-root css-1gjj37g']/div[1]"));
            ...
            for (WebElement cartItem : cartContents) {
                if(!expectedCartContents.contains(cartItem.findElement(By.className("css-1gjj37g")).getText().split("\n")[0])){
                    return false;
                }
            }
